...
var status = 1 # altera o status para "jogando" ou "parado"
var vscore = 0 # altera a pontuação
var x = 1.5  # muda a velocidade do cenário no eixo x (horizontal)
var y = 1.5  # muda a velocidade do cenário no eixo y (vertical)
